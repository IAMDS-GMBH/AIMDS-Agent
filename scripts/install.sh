...
# Configuration
REPO_URL_SSH="git@github.com:IAMDS-GMBH/AIMDS-Agent.git"
REPO_URL_HTTPS="https://github.com/IAMDS-GMBH/AIMDS-Agent.git"
...
copy_config_templates() {
    ...
    hermes_work_dir="$HOME/Documents/AIMDS-Suite-Vault"
...
EOF
    ...
    # Source: installer/skills-hidden/aimds-loadout/identity/SOUL.md (canonical)
...
SOUL_EOF
    log_success "Wrote ~/.hermes/SOUL.md (canonical identity + guardrails)"
