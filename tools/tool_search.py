...
_GERMAN_SYNONYMS: Dict[str, List[str]] = {
    ...
    "arbeitszeiten": ["workdays", "calendar", "event", "m365", "outlook", "schedule"],
    "arbeitszeitmodell": ["workdays", "profile", "week", "hours"],
    "wochenstunden": ["workdays", "weekly", "hours", "profile"],
    "teilzeit": ["workdays", "part", "time", "profile"],
    "vollzeit": ["workdays", "full", "time", "profile"],
    "istzeit": ["workdays", "report", "worklog", "sql", "actual"],
    "saldo": ["workdays", "report", "delta", "sql", "target"],
    "feiertag": ["workdays", "holiday", "calendar", "event", "m365", "outlook"],
    "feiertage": ["workdays", "holiday", "calendar", "event", "m365", "outlook"],
    "arbeitstag": ["workdays", "working", "days", "holiday"],
    "arbeitstage": ["workdays", "working", "days", "holiday"],
    "werktag": ["workdays", "working", "days"],
    "werktage": ["workdays", "working", "days"],
    "sollzeit": ["workdays", "target", "hours", "worklog", "tempo"],
    "sollstunden": ["workdays", "target", "hours", "worklog", "tempo"],
    "überstunden": ["workdays", "target", "hours", "worklog", "tempo", "sql"],
    "ueberstunden": ["workdays", "target", "hours", "worklog", "tempo", "sql"],
    "brückentag": ["workdays", "holiday", "calendar"],
    "brückentage": ["workdays", "holiday", "calendar"],
    "urlaubstage": ["workdays", "absences", "vacation", "calendar", "worklog"],
    "abwesenheit": ["workdays", "absences", "calendar", "event", "m365", "outlook", "vacation"],
    "abwesenheiten": ["workdays", "absences", "calendar", "event", "m365", "outlook", "vacation"],
    "krankheitstage": ["workdays", "absences", "sick", "days"],
