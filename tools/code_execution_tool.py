...
_TOOL_STUBS = {
    ...
    "write_file": (
        "write_file",
        "path: str, content: str, cross_profile: bool = False, allow_outside_workspace: bool = False",
        '"""Write content to a file (always overwrites). Returns dict with status. cross_profile=True opts out of the cross-Hermes-profile soft guard; allow_outside_workspace=True opts out of the workspace-boundary soft guard."""',
        '{"path": path, "content": content, "cross_profile": cross_profile, "allow_outside_workspace": allow_outside_workspace}',
    ),
    "search_files": (
        "search_files",
    ...
    "patch": (
        "patch",
        'path: str = None, old_string: str = None, new_string: str = None, replace_all: bool = False, mode: str = "replace", patch: str = None, cross_profile: bool = False, allow_outside_workspace: bool = False',
        '"""Targeted find-and-replace (mode="replace") or V4A multi-file patches (mode="patch"). Returns dict with status. cross_profile=True opts out of the cross-Hermes-profile soft guard; allow_outside_workspace=True opts out of the workspace-boundary soft guard."""',
        '{"path": path, "old_string": old_string, "new_string": new_string, "replace_all": replace_all, "mode": mode, "patch": patch, "cross_profile": cross_profile, "allow_outside_workspace": allow_outside_workspace}',
    ),
    "terminal": (
        "terminal",
