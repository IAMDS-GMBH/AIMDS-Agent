...
def profile_build_directive() -> str:
    ...
    return (
        ...
        "  1. Ask for whatever additional details they're comfortable sharing or confirming "
        "(name, what they do, how they like you to work). Volunteered/pre-loaded facts come first.\n"
