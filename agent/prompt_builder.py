...
TOOL_USE_ENFORCEMENT_MODELS = ("gpt", "codex", "gemini", "gemma", "grok", "glm", "qwen", "deepseek", "vllm", "suite", "aimds")
...
def build_remote_mcp_memory_prompt(valid_tool_names: "set[str] | None" = None) -> str:
    ...
    return (
        ...
        "Do not emit pre-tool filler text (for example: \"I'll start by loading memory context...\"). "
        "The first assistant output must be the memory_context tool call itself.\n"
