 ...
 * origin=git@github.com:IAMDS-GMBH/hermes-agent.git. A background
...
test('isSshRemote detects scp-like and ssh:// forms only', () => {
  assert.equal(isSshRemote('git@github.com:IAMDS-GMBH/hermes-agent.git'), true)
  assert.equal(isSshRemote('ssh://git@github.com/IAMDS-GMBH/hermes-agent.git'), true)
  assert.equal(isSshRemote('https://github.com/IAMDS-GMBH/hermes-agent.git'), false)
...
test('isOfficialSshRemote does NOT match forks, other hosts, or HTTPS', () => {
  ...
  assert.equal(isOfficialSshRemote('git@gitlab.com:IAMDS-GMBH/hermes-agent.git'), false)
  ...
  assert.equal(isOfficialSshRemote('https://github.com/IAMDS-GMBH/hermes-agent.git'), false)
