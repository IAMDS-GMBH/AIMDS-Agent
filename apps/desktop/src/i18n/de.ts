...
: Translations = {
  ...
  cron: {
    ...
    newCron: 'Neuer Cron',
    emptyDescNew:
      'Einen Prompt mit einem Cron-Ausdruck planen. Hermes führt ihn aus und liefert die Ergebnisse an das gewählte Ziel.',
    ...
    editDesc: 'Zeitplan, Prompt oder Zustellungsziel aktualisieren. Änderungen gelten beim nächsten Ausführen.',
