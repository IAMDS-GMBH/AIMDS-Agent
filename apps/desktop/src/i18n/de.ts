...
: Translations = {
  ...
  settings: {
    ...
    gateway: {
      ...
      supportDesc: 'Senden Sie Fehlerdiagnosen oder melden Sie Probleme direkt an das Support-Team.',
      reportIssueButton: 'Problem melden',
      supportTicketsTitle: 'Support-Tickets Status & Verlauf',
      ...
      supportTicketHeaderDate: 'Datum',
      supportTicketHeaderStatus: 'Status',
      supportTicketHeaderResolution: 'Lösungs-Hinweis',
      statusLabels: {
