...
export const en: Translations = {
  reportIssue: {
    ...
    fullLogs: 'Send full logs (instead of the focused excerpt)',
    previewTitle: 'What will be sent',
    previewLoading: 'Preparing diagnosis…',
    previewNoSignals: 'No known error patterns found in the current logs.',
    previewFiles: 'Files',
  ...
  settings: {
    ...
    appearance: {
      ...
      tipModeTitle: 'Tips & Loading Humor',
      tipModeDesc: 'Choose between professional business tips or technical developer & team humor.',
      ...
      filePickerRootUserDir: 'User Directory',
      filePickerRootVault: 'AIMDS-Suite-Vault',
      relaunchClient: 'Relaunch Client',
    ...
    gateway: {
      ...
      openLogs: 'Open logs',
      localConnTitle: 'Local connectivity',
      remoteConnTitle: 'Remote connectivity',
      ...
      hermesLocalApi: 'Hermes local API',
      statusUp: 'up',
      gatewayProcess: 'Gateway process',
      gatewayOptional: 'optional (not running)',
      dashboardAuthGate: 'Dashboard auth gate',
      authGateEnabled: (providers: string) => `enabled (${providers})`,
      authGateDisabled: 'disabled',
      configuredMcp: 'Configured MCP servers',
      criticalServices: 'Critical services',
      remoteHealthFailed: 'Remote health check failed',
      supportTitle: 'Support',
      sendSupportLogs: 'Send support logs',
      sendingSupportLogs: 'Sending support logs…',
      supportNotConfigured: 'Support logs are not configured yet. Set upload URL and API key below.',
      supportLogSettings: 'Support log upload settings',
      supportUploadUrlPlaceholder: 'https://support.example.com/api/log-upload',
      apiKeyPlaceholder: 'API key',
      apiKeySetPlaceholder: 'API key already set (enter to replace)',
      apiKeyConfigured: 'API key is currently configured.',
      apiKeyNotConfigured: 'API key not configured.',
      saveSupportSettings: 'Save support settings',
      savingLabel: 'Saving…',
      supportDesc: 'Send diagnostic logs or report issues directly to the support team.',
      reportIssueButton: 'Report an Issue',
      supportTicketsTitle: 'Support Tickets Status & History',
      ...
      supportTicketHeaderDate: 'Date',
      supportTicketHeaderStatus: 'Status',
      supportTicketHeaderResolution: 'Resolution Note',
      statusLabels: {
        queued: 'Queued',
    ...
    mcp: {
      ...
      reloadedMessage: 'MCP servers reloaded',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Hermes will run it and keep results on this desktop.',
    ...
    editDesc: 'Update the schedule or prompt. Changes apply on next run.',
