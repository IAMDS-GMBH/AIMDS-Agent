...
function isJsonOrYamlDocument(target: PreviewTarget, filePath: string): boolean {
  return DATA_LINK_EXT_RE.test(filePath) || DATA_LINK_EXT_RE.test(target.label || '') || DATA_LINK_EXT_RE.test(target.url || '')
}
