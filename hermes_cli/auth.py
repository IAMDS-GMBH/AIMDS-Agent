...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    "aimds-suite-prod": ProviderConfig(
        ...
        name="AIMDS-Suite",
        auth_type="api_key",
        inference_base_url="https://suite.iamds.com/litellm/v1",
    ...
    "aimds-suite-staging": ProviderConfig(
        ...
        auth_type="api_key",
        inference_base_url="https://staging.suite.iamds.com/litellm/v1",
    ...
    "aimds-suite-dev": ProviderConfig(
        ...
        auth_type="api_key",
        inference_base_url="https://dev.suite.iamds.com/litellm/v1",
...
def _resolve_provider_base_url_env(provider_id: str, pconfig: ProviderConfig) -> str:
    ...
    if env_url:
        return env_url
    if provider_id in ("iamds-litellm", "aimds-suite-prod"):
